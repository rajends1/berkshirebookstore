"""
Django settings for berkshirebookstore project.
...
SECRET_KEY = 'django-insecure-$$%aeug*v6hpce*r1dn2iq&z-w48#m(yu07i0bfbk+axa8ytla'
...
ROOT_URLCONF = 'berkshirebookstore.urls'
...
WSGI_APPLICATION = 'berkshirebookstore.wsgi.application'
